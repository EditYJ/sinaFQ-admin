<template>
    <div class="page">
            ...
            <el-collapse-item name="1">
                <template slot="title">
                    ...
                    <el-col :span="4" :offset="10"><div class="grid-content bg-purple"></div></el-col>
                        <el-button size="small" type="primary" @click.stop="normalQuery" plain>查询</el-button>
                    ...
                    <el-form ref="form" :model="searchForm" label-width="80px" class="elForm">
                        <el-col :span="6">
                            <el-form-item label="编号查询:">
                                <el-input size="small" v-model="searchForm.code" placeholder="订单编号/注册手机号/用户ID"></el-input>
                            </el-form-item>
                        </el-col>
                         <el-col :span="6">
                        ...
                        <el-col :span="11">
                            <el-form-item label="跟进时间:">
                                <el-col :span="12">
                                <el-date-picker size="small" type="date" placeholder="选择时间" v-model="searchForm.registerTime.startTime" style="width: 100%;"></el-date-picker>
                                </el-col>
        ...
        <el-dialog :visible.sync="failReasonDialog" title="失败原因">
            <el-input type="textarea" placeholder="失败原因"></el-input>
        ...
        <el-dialog title="取消组包" :visible.sync="cancelGroupDialog">
            <el-input type="textarea" placeholder="取消组包"></el-input>
            <span slot="footer" class="dialog-footer">
        ...
        <el-dialog title="取消原因" :visible.sync="cancelReasonDialog" class="myDialog">
            <el-input type="textarea" placeholder="取消原因"></el-input>
            <el-row>
