<template>
    <div class="page">
        ...
        <el-dialog title='取消售后' :visible.sync="cancelAfterBuyDialog">
            ...
            <el-input v-model="cancelAfterBuyReason" type="textarea" placeholder="请输入取消原因" maxlength="200" show-word-limit></el-input>
            <span slot="footer" class="dialog-footer">
        ...
        <el-dialog :visible.sync="applyAfterBuyDialog" class="applyDialog" top="3vh">
            ...
            <el-form ref="addDialogForm" label-position="center" :model="applyDialigForm" label-width="140px" >
                ...
                <el-form-item label="售后数量:" prop="num">
                    <el-col :span="14">
                        <el-input v-model="applyDialigForm.num" placeholder="请输入"></el-input>
                    </el-col>
                </el-form-item>

                <el-form-item label="售后原因:" prop="num">
                    <el-col :span="14">
                        <el-input v-model="applyDialigForm.reason" type="areatext" placeholder="请输入售后原因（选填）"></el-input>
                    </el-col>
                </el-form-item>

                <el-form-item label="邮件编码:" prop="num">
                    <el-col :span="14">
                        <el-input v-model="applyDialigForm.num" placeholder="选填"></el-input>
                    </el-col>
                </el-form-item>
                ...
                <el-form-item label="取件地址:" class="elForm">
                    ...
                    <el-row>
                        <el-col :span="14">
                            <el-input v-model="applyDialigForm.surviceType" placeholder="详情地址"></el-input>
                        </el-col>
                    </el-row>
                </el-form-item>
        ...
        <!-- 补充物流 -->
        <el-dialog title="补充物流" :visible.sync="addLogistDialog" ref="addLogistDialog" label-position="center" class="addLogist" label-width="140px">
            <el-form >
