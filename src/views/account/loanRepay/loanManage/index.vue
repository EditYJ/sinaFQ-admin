    ...
    <div class="page">
                    ...
                    <el-form ref="form" :model="postForm" label-width="80px" class="elForm">
                        ...
                        <el-col :span="8">
                            <el-form-item label="跟进时间">
                                ...
                                <el-col class="line" :span="1">-</el-col>
                                <el-col :span="11">
                                <el-date-picker placeholder="选择时间" v-model="postForm.date2" style="width: 100%;"></el-date-picker>
                                </el-col>
                            </el-form-item>
                        </el-col>
                    </el-form>
                ...
                <el-row>
                    ...
                    <el-col :span="5" offset="15">
                        <div class="grid-content bg-purple-dark">
                            <el-button type="primary" @click.native.prevent="switchDeploy" plain>开关配置</el-button>
                            <el-button type="primary" @click.native.prevent="checkCancel" plain>批量取消</el-button>
                        </div>
                    </el-col>
                </el-row>
            </el-header>
        ...
        <el-dialog title="开关配置" :visible.sync="switchDialog">
            <el-table :data="switchTable" height="auto" border style="100%">
                ...
                <el-table-column prop="" label="资金方"></el-table-column>
                <el-table-column prop="" label="放款开关状态"></el-table-column>
        ...
        <el-dialog title="取消放款" :visible.sync="cancelOrderDialog">
            <el-input type="textarea" placeholder="请输入取消放款原因"></el-input>
            <span slot="footer" class="dialog-footer">
        ...
        <el-dialog title="取消放款原因" :visible.sync="cancelReasonDialog">
            <el-input type="textarea" placeholder="取消放款原因" disabled></el-input>
