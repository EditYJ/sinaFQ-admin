          ...
          <el-form ref="form" :model="postForm" label-width="80px" class="elForm">
            <el-col :span="5">
              <el-form-item label="编号查询:">
                <el-input v-model="postForm.name" size="small" placeholder="账单编号/订单编号" />
              </el-form-item>
            </el-col>
            <el-col :span="4">
        ...
        <el-row>
          ...
          <el-col :span="5" offset="15">
            <div class="grid-content bg-purple-dark">
              <el-button type="primary" plain @click.native.prevent="orderRecord">挂帐记录</el-button>
              <el-button type="primary" plain @click.native.prevent="checkRepay">批量核销</el-button>
            </div>
          </el-col>
        </el-row>
      </el-header>
