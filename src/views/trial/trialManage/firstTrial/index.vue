<template>
    <div class="page">
        <div class="topButton">
            <el-row>
                <el-button size="small" :type="waitTrial" @click="checkState('waitTrial')">待初审(888)</el-button>
                <el-button size="small" :type="needTrial" @click="checkState('needTrial')">需重审(999)</el-button>
            </el-row>
        </div>
                        ...
                        <el-row>
                            <el-col :span="8">
                                <el-form-item label="输入查询:">
                                    <el-input size="small" v-model="postForm.name" placeholder="用户ID / 姓名/订单编号/注册手机号"></el-input>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :span="5">
                                <el-form-item label="分期金额">
                                    <el-col :span="10">
                                        <el-input v-model="postForm.startMoney" placeholder=""></el-input>
                                    </el-col>
                                    <el-col class="line" :span="0.5">-</el-col>
                                    <el-col :span="10">
                                        <el-input v-model="postForm.endMoney" placeholder=""></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
        ...
        <el-container class="groupList">
                ...
                <el-row>
                    ...
                    <el-col :span="5" offset="15">
                        <div class="grid-content bg-purple-dark">
                            <el-button type="primary" @click.native.prevent="refuseOrder" plain>批量拒绝</el-button>
                            <el-button type="primary" @click.native.prevent="turnOrder" plain>转 单</el-button>
                        </div>
                    </el-col>
                </el-row>
            </el-header>
            <el-main>
                <el-table :data="tableData" style="width: 100%">
                    <el-table-column prop="date" label="全选"></el-table-column>
                    <el-table-column prop="date" label="订单编号"></el-table-column>
                    <el-table-column prop="date" label="支付时间"></el-table-column>
                    <el-table-column prop="date" label="注册手机号" width="150"></el-table-column>
                    <el-table-column prop="date" label="信用分"></el-table-column>
                    <el-table-column prop="date" label="复借/复购" width="150"></el-table-column>
                    <el-table-column prop="date" label="订单类型"></el-table-column>
                    <el-table-column prop="date" label="分期金额"></el-table-column>
                    <el-table-column prop="date" label="订单金额"></el-table-column>
                    <el-table-column prop="date" label="分期期数"></el-table-column>
                    <el-table-column prop="date" label="机审决策"></el-table-column>
                    <el-table-column prop="date" label="初审处理人"></el-table-column>
                    <el-table-column prop="date" label="初审决策"></el-table-column>
                    <el-table-column prop="date" label="跟进时间"></el-table-column>
                ...
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="搜索">
                            <el-input type="" placeholder="请输入姓名/账号"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
