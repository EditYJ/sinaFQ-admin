          ...
          <el-row>
            ...
            <el-col :span="3" offset="17">
              <div class="grid-content bg-purple-dark">
                <el-button type="primary" plain @click="modifyGoods">批量导入</el-button>
              </div>
            </el-col>
          </el-row>
        </el-header>
          ...
          <template>
            <el-table :data="poolTableData" height="auto" border style="width: 100%">
              ...
              <el-table-column prop="goodsPriceSina" label="新浪定价" align="center">
                <template scope="scope">
                  <el-input v-model="scope.row.goodsPriceSina" size="mini" style="width:140px" placeholder="新浪定价">
              ...
              <el-table-column prop="goodsIptTime" label="操作" align="center">
                <template scope="scope">
                  <span style="color:green;cursor:pointer" @click="importGoods">导入</span>
                </template>
              </el-table-column>
            </el-table>
          </template>
      ...
      <el-dialog title="高级检索" :visible.sync="topQuaryDialog">
        <el-form ref="queryDialogForm" label-position="right" :model="queryDialogForm" label-width="180px">
          ...
          <el-form-item label="价格区间:">
            <el-row>
              <el-col :span="8">
                <el-input v-model="queryDialogForm.startPrice" size="small" type="number" />
              </el-col>
              <el-col :span="1" offset="1">-</el-col>
              <el-col :span="8">
                <el-input v-model="queryDialogForm.endPrice" size="small" type="number" />
              </el-col>
            </el-row>
          </el-form-item>
          ...
          <el-form-item label="协议价低于京东价超过:">
            <el-row>
              <el-col :span="10">
                <el-input v-model="queryDialogForm.price" size="small" type="number">
      ...
      <el-dialog title="批量导入" :visible.sync="modifyDialog">
        ...
        <el-form ref="modifyDialogForm" label-position="left" :model="modifyDialogForm" label-width="160px">
          ...
          <el-form-item label="新浪定价高于协议价：">
            <el-row>
              <el-col :span="10">
                <el-input v-model="modifyDialogForm.price" type="number">
